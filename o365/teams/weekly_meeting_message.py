class WeeklyMeetingMessage:
    ...
    def __init__(self, meeting_date, meeting_day, speakers, topics_master, meeting_folder, meeting_agenda) -> None:
        """initialize the message assignments"""
        self._message.format(meeting_date, meeting_day, speakers, topics_master, meeting_folder, meeting_agenda)
