...
class TeamsHelper:
    ...
    async def get_chanels(graph_client: GraphServiceClient, team_id: str):
    ...
    async def post_message(graph_client: GraphServiceClient, team_id: str, channel_id: str, message: str, attachment_url: str = None, content_type: str = 'application/vnd.ms-excel'):
        ...
        try:
            ...
            if attachment_url is not None:
                chat_message.attachments = [ChatMessageAttachment(
                                                content_type = content_type,
                                                content_url = attachment_url,
                                            )]
            request_body = chat_message
            print('Posting message')
            send_message_result = await graph_client.teams.by_team_id(team_id).channels.by_channel_id(channel_id).messages.post(request_body)
