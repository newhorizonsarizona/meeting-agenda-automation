...
class DriveHelper:
    ...
    async def get_drive_special(
        ...
        try:
            ...
            special_item = (
                ...
                .special.by_drive_item_id(item_id)
                .get()
            )
            return special_item
        except APIError as e:
    ...
    async def get_children_by_path(
        graph_client: GraphServiceClient, drive_id: str, relative_path: str = None
    ):
        ...
        try:
            ...
            url_by_path = (
                f"https://graph.microsoft.com/v1.0/drives/{drive_id}/{path_suffix}"
            )
    ...
    async def get_children_by_item(
        graph_client: GraphServiceClient, drive_id: str, item_id: str
    ):
